...
var Help = Class.create( {
    ...
    {
        var titleDiv = $( `<div style="color:#CCCCCC; font:bold; font-size:16px; text-align:center; margin-top:50px;">${arg}</div>` );
        this.wrapper.append( titleDiv );
    },
    ...
    {
        const thisFooter = $( `<div style="color:#CCCCCC; font:bold; font-size:16px; font-style:italic; text-align:left; margin-top:550px; margin-left:20px;">${arg}</div>` );
    ...
    create: function()
    {
        ...
        // this.createTitle();
        // this.createFooter();
        this.createTitle(this.helpArray[0].myTitle);
        this.createFooter(this.helpArray[0].myfooter);
